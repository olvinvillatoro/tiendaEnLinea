                ...
                <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                            <label>{{ __('Contraseña Nueva') }}</label>
                ...
                <div class="card-body">
                    <p class="card-text">
                        <div class="author">
                            ...
                            <a href="#">
                                <img class="avatar" src="{{ asset('black') }}/img/anime4.jpg" alt="">
                                <h5 class="title">{{ auth()->user()->name }}</h5>
                            </a>
                            <p class="description">
                              Se Unio El {{ auth()->user()->created_at }}
                            </p>
                        </div>
                    </p>
                    <div class="card-description">
                        {{ __('La gente común esta dispuesta a tolerarlo todo, si. Es capaz de vender la libertad por un poco de tranquilidad') }}
                        <p><b>A Clockwork Orange</b></p>
                    </div>
                </div>
                <div class="card-footer">
